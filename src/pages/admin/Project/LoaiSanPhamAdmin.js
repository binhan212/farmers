...
export default function LoaiSanPhamAdmin() {
    ...
    const sanphams = useSelector((state) => state.LoaiSanPhamReducer.loaisanphams);
  ...
  return (
    <div>
      <h1 className="h3 mb-3" style={{"cursor":"pointer"}}>
                <strong onClick={()=>{dispatch({ type: 'GET_LOAISANPHAM' })}}>Loại Sản Phẩm</strong>
            </h1>
